...
return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.name + "</td><td><a class='btn btn-primary btn-xs waves-effect waves-light blue darken-4 z-depth-0 less-pad' href='<?php echo site_url('site/editblogtag?id=');?>"+resultrow.id+"&blogid="+resultrow.blogid+"'><i class='fa fa-pencil propericon'></i></a><a class='btn btn-danger btn-xs waves-effect waves-light red pad10 z-depth-0 less-pad' onclick=return confirm(\"Are you sure you want to delete?\") href='<?php echo site_url('site/deleteblogtag?id='); ?>"+resultrow.id+"&blogid="+resultrow.blogid+"'><i class='material-icons propericon'>delete</i></a></td></tr>";
}
